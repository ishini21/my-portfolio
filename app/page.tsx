...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0a0f1e] px-6">
      ...
      <div className="relative z-10 max-w-3xl w-full">
        ...
        <p className="text-slate-400 text-lg leading-relaxed max-w-xl mb-3">
          ...
          <span className="text-slate-200 font-medium">SLIIT</span>, specialised
          in Software Engineering. I build full-stack web apps and RESTful APIs —
          and I&apos;m actively levelling up in{" "}
          <span className="text-indigo-300 font-medium">
            DevOps & Cloud (Linux → Docker → K8s)
          </span>{" "}
          for a career transition in 4–5 months.
        </p>
        ...
        <div className="mb-10 max-w-xs">
          ...
          <p className="text-xs text-slate-600 mt-1">
            Linux · Shell scripting · Docker → Ansible · K8s
          </p>
        </div>
        ...
        <div className="flex flex-wrap gap-4">
          <a
            href="#projects"
            className="px-6 py-3 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-sm transition-colors duration-200 shadow-lg shadow-indigo-600/25"
          >
            View My Projects
          </a>
          <a
            ...
            className="px-6 py-3 rounded-lg border border-slate-700 hover:border-indigo-500 text-slate-300 hover:text-white font-semibold text-sm transition-colors duration-200"
          >
            Download Resume ↓
          </a>
          <a
